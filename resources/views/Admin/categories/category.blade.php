                    ...
                    <tbody>
                        ...
                        @foreach($categories as $category)
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-sm btn-primary" href="{{url('admin/add-edit-category')}}/{{ $category['id']}}">Edit</a> | <a class="btn btn-sm btn-danger deletecategory" title="categorys" href="{{url('admin/delete-category')}}/{{ $category['id']}}">Delete</a></td>
                            </tr>
                      @endforeach
                    </tbody>
                  </table>
